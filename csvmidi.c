 ...
 * Returns FALSE if all fields were scanned successfully,
...
/*
 * XFIELDS  --  Parse one or more numeric fields.
 * This is a wrapper for xfields which specifies the default
...
/* CHECKBYTES  --  Pre-parse a sequence of arguments representing a byte vector.
 * If an error is detected, return TRUE.
 * Otherwise, reset the CSV parser to the first byte of the sequence and return FALSE.
 *  This permits code which handles arbitrary length byte
